...
export async function GET(req: Request) {
  ...
  // ── heygen-recover — poll HeyGen and trigger Remotion if complete ────────────
  // Use when HeyGen webhook failed to fire for a PROCESSING clip.
  // Usage: stage=heygen-recover&clipId=<clipId>
